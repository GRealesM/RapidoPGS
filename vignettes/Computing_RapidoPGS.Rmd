...
You'll also need `susieR` (even if you don't use RápidoPGS-multi)

Current RápidoPGS development version (v2.0.0) is currently available on GitHub, so we can install it using the following code (Note: If you don't have `remotes` installed, please install it first:
...
So those are examples of basic *RápidoPGS-single* usage! In future tutorials we'll demonstrate how to use the more complex *RápidoPGS-multi* approach.
